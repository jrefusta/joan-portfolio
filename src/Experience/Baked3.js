...
export default class Baked3 {
  ...
  setModel() {
    ...
    this.model.mesh = this.resources.items.roomModel3.scene; //.children[0];

    this.model.bakedDayTexture = this.resources.items.bakedDayTexture3;
